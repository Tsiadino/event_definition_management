...
config :event_definition_management, EventDefinitionManagement.Repo,
  ...
  password: "postgres",
  hostname: "localhost",
  database: "event_definition_management_test#{System.get_env("MIX_TEST_PARTITION")}",
...
config :event_definition_management, EventDefinitionManagementWeb.Endpoint,
  ...
  secret_key_base: "t+TaO2sNJBAsZDSzy7kXfAbrsyI7Tmey7fHf39UuFTUqDlRemvXIlD1+OrXfw8pN",
  server: false
